...
public class Main {
    ...
    public static void main(String[] args) throws NoSuchFieldException {
        final SonBean sonBean = Main.class.getDeclaredField("name").getAnnotation(SonBean.class);

        Class<? extends Annotation> annotationType = sonBean.annotationType();

//        Arrays.stream(annotationType.getAnnotations()).forEach(System.out::println);
